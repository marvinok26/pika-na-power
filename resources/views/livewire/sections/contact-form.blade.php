        ...
        <div class="w-full mx-auto container px-4 sm:px-6 lg:px-0 py-6 flex flex-col gap-5">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-20">
                ...
                <div
                    ...
                    <iframe src={{ $sectiondata->map_url }} width="100%" height="100%" style="border:0;"
                ...
                <div class="col-span-1">
                    ...
                    <form class="grid grid-cols-1 gap-4 dark:bg-slate-950">
                        ...
                        <div class="grid grid-cols-2 gap-4 mt-4">
                            <div data-aos="fade-left" class="col-span-1">
                                <label for="phone"
                                    class="block font-bold font-sans text-primary mb-2 dark:text-white">Phone
                                    (optional)</label>
                            ...
                            <div data-aos="fade-left" class="col-span-1">
                                <label for="subject"
                                    class="block font-bold font-sans text-primary mb-2 dark:text-white">Subject
                                    (optional)</label>
                                <input type="text" id="subject" name="subject" placeholder="Your subject"
                                    class="w-full bg-inputblue/50 dark:bg-gray-800 border-0 rounded-md p-2 text-black dark:text-white placeholder:text-sm">
                            </div>
                        </div>
                        <div data-aos="fade-left" class="mt-4">
                            <label for="message"
                                class="block font-bold font-sans text-primary mb-2 dark:text-white">Message
                                (required)</label>
                            <textarea id="message" name="message" placeholder="Your message(include as many details as possible)" rows="4"
                                class="w-full bg-inputblue/50 resize-none placeholder:text-sm dark:bg-gray-800 border-0 rounded-md p-2 text-black dark:text-white"></textarea>
                        </div>
                        <div data-aos="fade-left" class="mt-4">
                            <label class="block font-sans dark:text-white">How would you like us to reach out to
                                you?</label>
