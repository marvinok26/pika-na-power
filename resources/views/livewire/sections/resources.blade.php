        ...
        <div class="mx-auto max-w-7xl lg:px-0 px-10 pb-10">
            ...
            <div class="grid mt-8 grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
                ...
                @foreach ($resources as $resource)
                    <a href={{$resource->url}} target="_blank" rel="noreferrer" class="border-2 rounded-lg dark:border-black border-blue-400 bg-gray-50 py-6 px-16 text-center transition-transform transform hover:scale-105 hover:shadow-lg">
                        ...
                        <h2 class="text-blue-900 text-lg font-bold mb-4">{{$resource->title}}</h2>
