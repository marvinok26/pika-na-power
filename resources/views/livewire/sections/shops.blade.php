        ...
        <div class="mx-auto container pb-10">
            ...
            <div class="grid mt-8 grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                ...
                @foreach ($shops as $shop)
                    <a data-aos="flip-right" href={{ $shop->url }}
                        class="border-2 rounded-xl dark:border-black border-sky-300 text-center bg-gray-50 p-6 hover:border-blue-800">
                        <img src={{ url('storage/' . $shop->logo) }} class="h-28 mx-auto text-center object-contain"
                            alt="">
                    </a>
                @endforeach
            </div>
