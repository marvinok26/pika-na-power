                    ...
                    <div class="mx-auto grid max-w-2xl auto-rows-fr grid-cols-1 gap-8 sm:mt-4 lg:mx-0 lg:max-w-none lg:grid-cols-4">
                        ...
                        @foreach ($articles as $article)
                            <article class="relative isolate flex flex-col transition-transform transform hover:scale-105 justify-end overflow-hidden rounded-2xl bg-light px-4 pb-8 pt-32 sm:pt-40 lg:pt-72">
                                ...
                                <!-- Metadata Section -->
                                <div class="flex font-sans flex-wrap items-center gap-y-1 overflow-hidden text-xs leading-6">
                                    <time datetime="{{$article->date->format('Y-m-d')}}" class="text-slate-200 mr-6">{{$article->date->format('M j, Y')}}</time>
                                </div>
