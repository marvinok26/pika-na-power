        ...
        <div class="mx-auto container lg:px-0 px-10 pb-10">
            ...
            <div class="owl-carousel owl-carousel-2 owl-theme mt-5">
                @foreach ($partners as $partner)
                    <div class="item">
                        <a href={{ $partner->url }} target="_blank" rel="noreferrer" class="border-2 rounded-xl border-sky-300 dark:border-black bg-gray-50 p-6 text-center hover:border-blue-800">
