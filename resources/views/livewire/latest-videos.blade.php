<div class="bg-white dark:bg-gray-950 py-12 sm:py-16">
    <div class="mx-auto lg:px-0 px-4 max-w-7xl">
        <div class="mx-auto flex flex-col items-center sm:flex-row sm:justify-between mb-8 ">
            <h2 class="text-3xl font-medium	 tracking-tight lg:pb-0 pb-5 text-gray-900 dark:text-white sm:text-3xl">
                Latest
                Videos</h2>
        ...
        <div class="mx-auto grid max-w-2xl auto-rows-fr grid-cols-1 gap-8 sm:mt-4 lg:mx-0 lg:max-w-none lg:grid-cols-4">
            ...
            <article class="relative isolate flex flex-col transition-transform transform hover:scale-105 justify-end overflow-hidden rounded-2xl bg-gray-900 px-4 pb-8 pt-44 sm:pt-60 lg:pt-56 h-full">
                ...
                <img src="/images/video.svg" class="absolute text-yellow top-2/3 mb-8 left-1/2 transform -translate-x-1/2 -translate-y-28 h-12 w-12 fill-white" alt="">
                ...
                <div class="flex mt-3 flex-wrap items-center gap-y-1 overflow-hidden text-base leading-6 text-gray-300">
