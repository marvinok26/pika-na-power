    ...
    <div class="mx-auto max-w-7xl lg:px-0 px-10 pb-10">
        <div class="flex flex-wrap justify-center items-center -mx-4">
            ...
            <div class="w-full md:w-1/2 px-4">
                <p data-aos="fade-left" class="text-black dark:text-white text-base">Laborum occaecat aliquip ad labore
                    irure do exercitation
                    aliqua aliquip enim laboris adipisicing. Occaecat fugiat cupidatat nulla. Ad aliqua enim magna irure
                    incididunt aliqua nulla do duis.</p>
        ...
        <div class="grid mt-8 grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
            <!-- Item 1 -->
            @for ($i = 0; $i < 8; $i++)
                <a data-aos="flip-right" href="#"
                    class="border-2 rounded-lg dark:border-gray-400 border-blue-400 bg-gray-50 dark:bg-slate-950 py-6 px-16 text-center transition-transform transform hover:scale-105 hover:shadow-lg">
