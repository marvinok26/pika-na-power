    ...
    <div class="mx-auto max-w-7xl lg:px-0 px-10 pb-10">
        <div class="flex flex-wrap justify-center items-center -mx-4">
            ...
            <div class="w-full md:w-1/2 px-4">
                <p class=" text-black text-base">Join us on our mission to create a brighter future, leveraging innovative strategies and deep local insights to drive meaningful progress. Together, we can turn your vision into reality.</p>
        ...
        <div class="grid mt-8 grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
            <!-- Item 1 -->
            @for ($i = 0; $i < 4; $i++)
            <a href="#" class="border-2 rounded-lg border-blue-400 dark:border-black bg-gray-50 p-6 text-center transition-transform transform hover:scale-105 hover:shadow-lg">
                <div class="flex justify-center mb-4">
                    <img src="/images/cooker.svg" alt="Placeholder Image" class="circle rounded-full p-2">
                </div>
                <h2 class="text-blue-900 dark:text-black text-lg font-bold mb-4">Item Title</h2>
