    ...
    <div class="mx-auto max-w-7xl lg:px-0 px-10">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-20">
            ...
            <div class="flex flex-col justify-center">
                <h2 class="text-2xl font-medium mb-4 dark:text-white text-[#163466]">Embrace Clean Technologies for a Greener Cooking Future with Pika na Power!</h2>
                ...
                <a href="/articles" wire:navigate class="text-white w-48 bg-[#163466] mt-8 focus:ring-4 focus:outline-none focus:ring-gray-100 font-normal rounded-lg text-base px-5 py-2.5 text-center inline-flex items-center">
                    <span class="mr-2">Show Me More</span>
